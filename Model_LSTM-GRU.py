...
def main():
    ...
    """)
    industries = [
        'Xây dựng', 'Bất động sản', 'Vật liệu xây dựng & Nội thất', 'Nước',
       'Kho bãi, hậu cần và bảo dưỡng', 'Nuôi trồng nông & hải sản',
       'Thực phẩm', 'Sản xuất & Phân phối Điện', 'Hàng May mặc',
       'Dược phẩm', 'Thép và sản phẩm thép',
       'Sản phẩm hóa dầu, Nông dược & Hóa chất khác',
       'Môi giới chứng khoán', 'Nhựa, cao su & sợi',
       'Phân phối xăng dầu & khí đốt', 'Máy công nghiệp',
       'Sách, ấn bản & sản phẩm văn hóa', 'Chất thải & Môi trường',
       'Khai khoáng', 'Ngân hàng', 'Containers & Đóng gói',
       'Vận tải Thủy', 'Dịch vụ vận tải', 'Vận tải hành khách & Du lịch',
       'Sản xuất bia', 'Đồ uống & giải khát', 'Tư vấn & Hỗ trợ KD',
       'Lâm sản và Chế biến gỗ', 'Khai thác Than', 'Hàng điện & điện tử',
       'Sản xuất ô tô', 'Thiết bị điện', 'Bán lẻ phức hợp', 'Phần mềm',
       'Thiết bị viễn thông', 'Bảo hiểm phi nhân thọ',
       'Phân phối hàng chuyên dụng',
       'Tư Vấn, Định giá, Môi giới Bất động sản', 'Khách sạn',
       'Thiết bị và Dịch vụ Dầu khí', 'Hàng cá nhân', 'Sản xuất giấy',
       'Dịch vụ giải trí', 'Thiết bị gia dụng', 'Đào tạo & Việc làm',
       'Nhà cung cấp thiết bị', 'Tài chính đặc biệt',
       'Viễn thông cố định', 'Thiết bị y tế', 'Dịch vụ truyền thông',
       'Vang & Rượu mạnh', 'Thuốc lá', 'Công nghiệp phức hợp',
       'Xe tải & Đóng tàu', 'Lốp xe', 'Phân phối thực phẩm', 'Phần cứng',
       'Sản xuất và Khai thác dầu khí', 'Dịch vụ Máy tính',
       'Viễn thông di động', 'Dụng cụ y tế', 'Hàng không',
       'Nhà hàng và quán bar', 'Giầy dép', 'Giải trí & Truyền thông',
       'Tiện ích khác', 'Chuyển phát nhanh', 'Đồ gia dụng lâu bền',
       'Tái bảo hiểm', 'Điện tử tiêu dùng', 'Nhôm', 'Chăm sóc y tế',
       'Đường sắt', 'Đồ chơi', 'Đồ gia dụng một lần', 'Khai thác vàng',
       'Bảo hiểm nhân thọ', 'Internet', 'Phân phối dược phẩm',
       'Công nghệ sinh học', 'Tài chính cá nhân', 'Phụ tùng ô tô',
       'Quản lý tài sản', 'Dịch vụ tiêu dùng chuyên ngành',
       'Kim Loại màu', 'Thiết bị văn phòng'
    ]
